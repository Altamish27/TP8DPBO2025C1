<div class="row mb-3">
    <div class="col-md-6">
        <h2>Create Course Registration</h2>
    </div>
...
<div class="card">
    <div class="card-header bg-primary text-white">
        <h3 class="card-title">Course Registration Information</h3>
    </div>
    <div class="card-body">
        <form method="post" action="index.php?controller=studentCourse&action=create">
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="student_id" id="student_id" class="form-select" required>
                            ...
                            <?php foreach ($students as $student): ?>
                                <option value="<?= $student['id'] ?>"><?= $student['name'] ?> (<?= $student['nim'] ?>) - <?= $student['prodi_name'] ?? 'No Program' ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="course_id" id="course_id" class="form-select" required>
                            ...
                            <?php foreach ($courses as $course): ?>
                                <option value="<?= $course['id'] ?>"><?= $course['name'] ?> (<?= $course['code'] ?>) - <?= $course['credits'] ?> credits</option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
