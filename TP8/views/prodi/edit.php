...
<div class="card">
    <div class="card-header bg-warning">
        <h3 class="card-title">Edit Study Program Information</h3>
    </div>
    <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="code" id="code" class="form-control" value="<?= $prodi['code'] ?>" required>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="<?= $prodi['name'] ?>" required>
