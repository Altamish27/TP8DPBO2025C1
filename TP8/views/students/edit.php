...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="index.php?controller=student&action=edit&id=<?= $student['id'] ?>">
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="date" name="join_date" id="join_date" class="form-control" value="<?= $student['join_date'] ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="prodi_id" id="prodi_id" class="form-select" required>
                    ...
                    <?php foreach ($prodis as $prodi): ?>
                        <option value="<?= $prodi['id'] ?>" <?= ($prodi['id'] == $student['prodi_id']) ? 'selected' : '' ?>>
